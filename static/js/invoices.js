window.addEventListener('DOMContentLoaded', function () {
    ...
    var invoiceFilter = document.getElementById('invoice-filter-select');
    ...
    if (invoiceFilter) {
        ...
        invoiceFilter.addEventListener('change', updateInvoiceFilter);


        function updateInvoiceFilter() {
            if (invoiceFilter.value == 'notsent') {
                window.location.href = "/invoices?filter=notsent";
            } else if (invoiceFilter.value == 'sent') {
                window.location.href = "/invoices?filter=sent";
            } else if (invoiceFilter.value == 'paid') {
                window.location.href = "/invoices?filter=paid";
            } else {
